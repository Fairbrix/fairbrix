...
public:
    CMainParams() {
        ...
        consensus.BIP16Height = std::numeric_limits<int>::max(); // 87afb798a3ad9378fcd56123c81fb31cfd9a8df4719b9774d71730c16315a092 - October 1, 2012
        ...
        consensus.BIP65Height = std::numeric_limits<int>::max(); // bab3041e8977e0dc3eeff63fe707b92bde1dd449d8efafb248c27c8264cc311a
        consensus.BIP66Height = std::numeric_limits<int>::max(); // 7aceee012833fa8952f8835d8b1b3ae233cd6ab08fdb27a771d2bd7bdc491894
        consensus.CSVHeight = std::numeric_limits<int>::max(); // 53e0af7626f7f51ce9f3b6cfc36508a5b1d2f6c4a75ac215dc079442692a4c0b
        consensus.SegwitHeight = std::numeric_limits<int>::max(); // 0000000000000000001c8018d9cb3b742ef25114f27563e3fc4a1902167f9893
        ...
        genesis = CreateGenesisBlock(1317529878, 385610221, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(genesis.hashMerkleRoot == uint256S("0x40a627262ed716f0f3d5104315fe0b600bf8e32a021929299163f74151fa52b1"));
        assert(consensus.hashGenesisBlock == uint256S("0x002a91713910bc96eb0edf237fcd2799d7a01186e1e96023e860bc70b3916200"));
        ...
        vSeeds.emplace_back("fbx.kawaii.kiwi");
        ...
        checkpointData = {
            {
        	{    50, uint256S("0x4f8a5ab946d64c19a4f3dacffc6014e47735fd12984e89d7436790accb115a3b")},
        	{    57, uint256S("0x034a3d32d1324130954f33ee7ad008012373ec93d01540d2a1a85d30a19770ed")},
        	{  5000, uint256S("0x9289ee81e679e10e6ed01232e70c19c9ef9682a38489227cd521a0136649b1ad")},
        	{ 15000, uint256S("0x7c7fc755c19616fd3eb156b53dae2bbf058972e0731f3d0ee54785cc222f4bbf")},
        	{114000, uint256S("0xf863ed327eede0641e1be668d43144e67c52c0785524faff2dd1a21bbdeabfbe")},
        	{116144, uint256S("0x7d0f9db5dbb9378ddd5bdd173b3c71fef8808690adec8ecc0bbb1b3648871b76")},
        	{120000, uint256S("0x8eba390707d2de0af87f7f6c1e191de995a351d3cb1ac1667d83c207f4580217")},
        	{123340, uint256S("0xfc425e4e4044bb8016a5bf7a3a8daaf5e5753017cd82c76cb8f168791b5b1986")},
        	{125000, uint256S("0x24d37d00a27106edb6acd213914b89c64396eef2a8e7957d22a46779b1300d9f")},
        	{125882, uint256S("0x350844dc30528e80f61ec00abb6c822493d401a165e0ef94ee0667ef8b76cf96")},
        	{128935, uint256S("0x6272ad45f8a3933718635c81eaf89a8c1271dea1f8ac776db091b6f7109be390")},
        	{130000, uint256S("0x96078b2d0c993fbee6041620a25076e7960e384bb3a5a4147b44f900687a3cf5")},
        	{131555, uint256S("0x52d456035f3dc3942d0aeb5662522f5bad59fc70f7e420917a140cf4b31320b0")},
        	{135000, uint256S("0xfdd4f9980cb734537e613718271a17b2d65169751779130839c59f8b62b4ed07")},
        	{137210, uint256S("0x35aefe3d8fad5952fa921ea0b235a7732b380af5d6a2e9e7cf757daf3f44a1b1")},
        	{140000, uint256S("0x9945603d44043bead1fb58733af3485346afcaf30cc34662792b7c761cb6a363")},
        	{145000, uint256S("0x03a40c535e5255708fcabce83c72adac5e6104bc018d27741ab3a5cb0bce635e")},
        	{148092, uint256S("0x8e87a19fe174db177ab5e0424037ce8218dfbfb4b53ac76b97190da62005bd92")},
        	{150000, uint256S("0x4991ffa9b3e1b33c187c2a49370ecc060d81f0af49f06b80df369360a9769d84")},
        ...
        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 2016 7207c10a2953745431bc856edeab5577ed42e213bba9b3b6b44c438cd64cd7ff
            /* nTime    */ 1375631575,
            /* nTxCount */ 166597,
            /* dTxRate  */ 0.001791633467889262
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.fairbrixtools.com");
        vSeeds.emplace_back("seed-b.fairbrix.loshan.co.uk");
